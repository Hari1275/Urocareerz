                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-2xl font-bold">{analyticsData.overview.totalDiscussions}</div>
                        <p className="text-xs text-muted-foreground">{analyticsData.overview.deletedDiscussions} Archived</p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
