    ...
    <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-full overflow-hidden">
                ...
                {formData.opportunityTypeId &&
                  (() => {
                    const selectedType = opportunityTypes.find(
                      (type) => type.id === formData.opportunityTypeId
                    );
                    if (selectedType) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        ...
        <div className="space-y-2 min-w-0">
          ...
          <p className="text-xs text-gray-500">
            Enter amount without ₹ symbol. Use "Free", "Unpaid", or "Volunteer"
            for non-paid opportunities.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-row justify-end gap-3 w-full">
        <Button
          ...
          disabled={loading}
          className="flex-1 sm:flex-none sm:w-auto max-w-[120px]"
        >
          Cancel
        </Button>
        <Button type="submit" disabled={loading} className="flex-1 sm:flex-none sm:w-auto max-w-[160px]">
    ...
    return (
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Share an opportunity you&apos;ve found with the community. It will
